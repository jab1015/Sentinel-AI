...
- Current source checkpoint before this documentation commit: `3e4ece61f67c9088a78f294bec5f1264fb7db180`
...
The exact-head workflows for `3e4ece61f67c9088a78f294bec5f1264fb7db180` were **QUEUED** at the latest check. This includes broad Windows CI, subprocess-boundary, driver-repair policy, x86/ARM64 package architecture, x64 package, architecture builds, and other focused gates. Queued/running work is not counted as PASS.
...
2. Move A09/A17 to source-complete only if the exact-head subprocess audit and relevant broad Windows integration are green.
3. Validate the strengthened A10/A11 driver-repair policy on exact-head CI and retain installed/device runtime requirements.
4. Finish A29 x86/ARM64 package architecture verification without dropping declared architectures; then perform real architecture runtime qualification later.
5. Finish A21/A22 integration/resource review and A24 exact-head validation.
...
7. Complete remaining Windows runtime/fault matrices.
