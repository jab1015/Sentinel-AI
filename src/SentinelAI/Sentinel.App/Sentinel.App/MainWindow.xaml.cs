...
namespace Sentinel.App
{
    public sealed partial class MainWindow : Window
    {
        ...
        private readonly ApprovedFirewallContainmentCoordinator _approvedFirewallContainmentCoordinator = new();
