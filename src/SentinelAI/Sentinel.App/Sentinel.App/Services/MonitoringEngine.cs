    ...
    public class MonitoringEngine
    {
        ...
        private async Task RefreshCoreAsync()
        {
            ...
            SystemSnapshot snapshot = new()
            {
                ...
                ServiceMonitoringAvailable = _serviceSnapshot.CollectionAvailable, InstalledServiceCount = _serviceSnapshot.InstalledServiceCount, RunningServiceCount = _serviceSnapshot.RunningServiceCount, FlaggedServiceCount = _serviceSnapshot.FlaggedServiceCount, PrimaryFlaggedServiceName = _serviceSnapshot.PrimaryServiceName, PrimaryFlaggedServiceReason = _serviceSnapshot.PrimaryReason,
            ...
            snapshot.ProtectionHealthFullyProtected = protectionHealth.FullyProtected;
            snapshot.ProtectionHealthTitle = protectionHealth.Title;
            snapshot.ProtectionHealthSummary = protectionHealth.Summary;
        ...
        private async Task RefreshServiceDataIfDueAsync(DateTime now)
        {
            ...
            if (!result.Success)
            {
                _serviceSnapshot = ServiceMonitor.ServiceIntelligenceSnapshot.Unavailable;
