...
namespace Sentinel.App.Services
{
    public class MonitoringEngine
    {
        ...
        public async Task RefreshAsync()
        {
            ...
            ProcessMonitor.ProcessIntelligenceSnapshot processIntelligence =
                _processMonitor.GetIntelligence();
            ...
            SystemSnapshot snapshot = new()
            {
                ...
                ProcessCount = processIntelligence.TotalProcessCount,
                ...
                FlaggedProcessCount = processIntelligence.FlaggedProcessCount,
                PrimaryFlaggedProcessName = processIntelligence.PrimaryProcessName,
                PrimaryFlaggedProcessReason = processIntelligence.PrimaryReason,
